...
<html lang="en">
    <head>
        <title>Abiyyu Ardilian - Portofolio</title>
        <meta charset="utf-8">
    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="index.html">RDN ABIYYU</a>
                        ...
                        <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
                            ...
                            <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                                <div class="text">
                                    ...
                                    <h1 class="mb-4 mt-3">I'm <span>Abiyyu Ardilian</span></h1>
                                    <h2 class="mb-4">A Freelance Programmer</h2>
                    ...
                    <div class="container">
                        <div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
                            ...
                            <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                                <div class="text">
                                    <span class="subheading">Hello!</span>
                                    <h1 class="mb-4 mt-3">I'm a <span>Freelancer Programmer</span> based in Surabaya</h1>
                                    <p><a href="#" class="btn btn-primary py-3 px-4">Hire me</a> <a href="#" class="btn btn-white btn-outline-white py-3 px-4">My works</a></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row d-flex">
                    <div class="col-md-6 col-lg-5 d-flex">
                        <div class="img-about img d-flex align-items-stretch">
                            <div class="overlay"></div>
                            <div class="img d-flex align-self-stretch align-items-center" style="background-image:url(images/bg1.png);"></div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
                        <div class="row justify-content-start pb-3">
                            <div class="col-md-12 heading-section ftco-animate">
                                ...
                                <p>Saya adalah seorang individu yang berdedikasi dalam bidang teknologi informasi, memiliki semangat belajar yang tinggi dan pengalaman dalam pengembangan aplikasi berbasis web. Saat ini berdomisili di Surabaya dan aktif mengembangkan berbagai proyek perangkat lunak untuk kebutuhan bisnis dan organisasi.</p>
                                <ul class="about-info mt-4 px-md-0 px-2">
                                    <li class="d-flex"><span>Name:</span> <span>R. Abiyyu Ardi Lian Permadi</span></li>
                                    <li class="d-flex"><span>Date of birth:</span> <span>May 17, 2000</span></li>
                                    <li class="d-flex"><span>Address:</span> <span>Rumdis TNI-AL Wonosari A.320 Surabaya</span></li>
                                    <li class="d-flex"><span>Zip code:</span> <span>60127</span></li>
                                    <li class="d-flex"><span>Email:</span> <span>abiyyuardilian213@gmail.com</span></li>
                                    <li class="d-flex"><span>Phone: </span> <span>+62 895 3970 43901</span></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center pb-5">
                    <div class="col-md-10 heading-section text-center ftco-animate">
                        ...
                        <p>Berikut ini adalah ringkasan perjalanan pendidikan, pengalaman kerja, serta keahlian yang saya miliki. Resume ini mencerminkan dedikasi dan semangat saya dalam mengembangkan diri di dunia profesional, khususnya dalam bidang teknologi dan pengembangan aplikasi.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
